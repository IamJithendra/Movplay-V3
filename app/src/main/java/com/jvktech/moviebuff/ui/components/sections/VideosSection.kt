...
import com.jvktech.moviebuff.data.model.VideoSite
import com.jvktech.moviebuff.data.model.getThumbnailUrl
...
private fun SiteIcon(site: VideoSite, modifier: Modifier = Modifier) {
    ...
    val drawableRes = when (site) {
        VideoSite.YouTube -> com.jvktech.moviebuff.R.drawable.ic_youtube
        VideoSite.Vimeo -> com.jvktech.moviebuff.R.drawable.ic_vimeo
    }
